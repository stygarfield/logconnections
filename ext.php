...
{
	const LOG_CONNECTIONS_VERSION = '2.1.0 RC4';
	...
	*/
	public function is_enableable()
	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/logconnections');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/logconnections', 'ext_enable_error');
			}
		}
